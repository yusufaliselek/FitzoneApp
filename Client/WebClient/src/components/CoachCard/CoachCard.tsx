...
const CoachCard = ({ name, profession}: { name: string, profession: string, }) => {
    ...
    return (
        <div className="flex flex-col justify-center w-80 max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-gray-400 dark:text-gray-100">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
                <div className="my-2 space-y-1">
                    <h2 className="text-xl font-semibold sm:text-2xl cursor-pointer hover:text-slate-500 transition-all" onClick={handleClick}>{name}</h2>
                    <p className="px-5 text-xs sm:text-base text-gray-800">{profession}</p>
                </div>
                <div className="flex justify-center pt-2 space-x-4 align-center">
                    <a rel="noopener noreferrer" href="tel:" aria-label="Whatsapp" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                        <FaWhatsapp />
                    </a>
