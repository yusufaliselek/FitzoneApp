...
export const AccountMenu = ({firstName, lastName} : {firstName: string, lastName:string,}) => {
        ...
        <div>
            <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
                <Tooltip title={fullName}>
                    <IconButton
                        onClick={handleClick}
                        size="small"
                        sx={{ padding: 1, color: 'rgb(30 64 175)' }}
            ...
            >
                <MenuItem className='gap-x-1'>
                    <img src={data} className='w-8 h-8 rounded-full'/> {fullName}
                </MenuItem>
                <Divider />
